                ...
                <div class="price__body">
                    ...
                    <div class="price__items">
                        <div class="price__item">
                            Сайт визитка: от $150<br>
                            Сайт визитка + админ панель: от $200
                        </div>
                        <div class="price__item">
                            Лэндинг: от $200<br>
                            Лэндинг+админ панель: от $250
                        </div>
                        <div class="price__item">
                            Блог: от $280<br>
                            Блог + админ панель: от $320
                        </div>
                        <div class="price__item">
                            Интернет-магазин: от $470<br>
                            Интернет-магази + админ панель: от $500
                        </div>
                        <div class="price__item">
                            Админ панель: от $100<br>
                            (в зависимости от наполнения и возможностей)<br>
                            Каждый дополнительный модуль от $32
                        </div>
                    </div>
